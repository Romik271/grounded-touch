...
export const strings = {
  en: {
    ...
    hero: {
      ...
      titleB: 'to recover.',
      lede: 'Thai massage in Munich Schwabing, in a calm private space. Attentive sessions for tired legs, tense muscles, and the whole body.',
      cta: 'Book a session',
  ...
  de: {
    ...
    hero: {
      ...
      titleB: 'zur Erholung.',
      lede: 'Thai Massage in München Schwabing, in einem ruhigen privaten Raum. Aufmerksame Sessions für müde Beine, verspannte Muskeln und den ganzen Körper.',
      cta: 'Termin buchen',
